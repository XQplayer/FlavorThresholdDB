...
export default function MirrorSpectrumPlot({ spectrumA, spectrumB, comparison }) {
  ...
  return (
    <svg id="open-spectra-mirror" className="mirror-spectrum-plot" viewBox="0 0 720 310" role="img" aria-label="Aligned mirror spectrum comparison">
      <line x1="42" y1="150" x2="706" y2="150" className="spectrum-axis" />
      {renderPeaks(peaksA, 'a')}
      {renderPeaks(peaksB, 'b')}
      <text x="10" y="28">A</text><text x="10" y="286">B</text><text x="664" y="302">m/z</text>
    </svg>
  );
}
